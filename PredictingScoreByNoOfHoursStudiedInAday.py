...
#his Project is Developed by Om Prakash as Intern in The Sparks Foundation (Data Science And Business Analyst)
#Predicting Score Of Student By No Of Hours Studied By Student 
import pandas, numpy
...
loop=True
while(loop):
    x=input('Enter No Of Hours studied in hrs')
    x=float(x)
